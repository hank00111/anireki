...
export const seoData: Record<string, MultiLangSEO> = {
  home: {
    ...
    en: {
      ...
      description: "Track seasonal anime and record all your watched anime. Easily manage your anime watchlist and viewing history.",
      keywords: "anime,tracker,seasonal,watchlist,viewing history,collection"
    },
    ja: {
      title: "ホーム - Anireki | アニメトラッカー",
      description: "季節のアニメを追跡し、視聴したすべてのアニメを記録します。アニメのウォッチリストと視聴履歴を簡単に管理できます。",
...
export function generateWebsiteSchema() {
  const schema = {
    ...
    "@type": "WebSite",
    "name": "Anireki",
    "alternateName": ["アニレキ", "動畫記錄"],
    "url": "https://anireki.com",
    "description": "Track your anime watching history and discover new seasonal anime",
